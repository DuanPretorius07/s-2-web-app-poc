    ...
    <div className="min-h-screen relative" style={{ backgroundColor: 'transparent' }}>
      ...
      <div className="max-w-4xl mx-auto py-6 sm:px-6 lg:px-8 relative z-10">
        <div className="px-4 sm:px-0">
          <div className="bg-white shadow rounded-lg p-6 bg-opacity-95">
            <div className="mb-6">
              <Link to="/history" className="text-s2-red hover:text-s2-red-dark text-sm font-medium">
                ← Back to History
              </Link>
            ...
            <div className="space-y-6">
              ...
              {/* Link to Quote */}
              {booking.quoteRequest?.id && (
                <div className="pt-4 border-t border-gray-200">
                  <Link
                    to={`/history/quotes/${booking.quoteRequest.id}`}
                    className="text-s2-red hover:text-s2-red-dark text-sm font-medium"
                  >
                    View original quote →
                  </Link>
                </div>
